...
class PermissionVoterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreation()
    {
        $voter = new PermissionVoter(
            $this->getMockForAbstractClass('Symfony\Component\Routing\RouterInterface'),
            $this->getMockForAbstractClass('Symfony\Component\HttpFoundation\RequestStack')
        );

        $this->assertInstanceOf('Tenside\CoreBundle\Security\PermissionVoter', $voter);
    }
